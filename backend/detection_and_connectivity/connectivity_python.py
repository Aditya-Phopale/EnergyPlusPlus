...
def visualize_result(result, connectivity, entity_labels, centers):
...
def detect_rooms(image_path, model_path):
    ...
    return bb_dataframe, result


if __name__ == "__main__":
    image_path = "./image0.jpg"
    model_path = "./best.pt"
    detected_boxes, result = detect_rooms(image_path, model_path)
    connectivity_dict, entity_labels, centers = connect_rooms(result)
    visualize_result(result, connectivity_dict, entity_labels, centers)
