...
const Model = () => (
    <Layout>
        <div className="container text-center my-5">
            <h1> Results of default floor plan 3</h1>
            <br/>
        ...
        <div class = "container">
            <div className="row">
                <div class="col">
                    ...
                    <StaticImage
                        src="../images/Default_floorplans/3.png"
                        width={500}
                        quality={95}
                        formats={["AUTO", "WEBP"]}
                ...
                <div className="col">
                    ...
                    <StaticImage
                        src="../images/Default_floorplans/graph_viz_3.png"
                        width={500}
                        quality={100}
                        formats={["AUTO", "WEBP"]}
                ...
                <div className="col">
                    ...
                    <StaticImage
                        src="../images/Default_floorplans/Prototype_Model_Simple_3.png"
                        width={500}
                        quality={100}
                        formats={["AUTO", "WEBP"]}
                        alt="modelling results"
